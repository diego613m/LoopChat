...
test.describe.parallel('Federation - XMPP', () => {
	...
	test.describe('Join rooms', () => {
		...
		test.skip('expect to join an external XMPP room using /xmpp join from a local user', testToBeImplemented);
		test.skip('expect to reject /xmpp join when no XMPP room alias is provided', testToBeImplemented);
